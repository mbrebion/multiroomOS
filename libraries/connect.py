...
class Connect():
    ...
    async def _main(self):
        ...
        self.server = await asyncio.start_server(self._handleClient, self._get_local_ip(), tcpPortServer, start_serving=False)
    ...
    async def _handleClient(self, reader, writer):
        ...
        while self.alive :
            ...
            try:
                ...
                logging.warning("problem with device : "+ clientName+ " during tcp read (in _handleClient)")
                data=-1
